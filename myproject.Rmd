...
csl: ecology.csl# hay que descargarselo y guardarlo
---
...
```{r}
library(checkpoint)
checkpoint("2016-05-12")# ese script funcionaba el 12 de mayo, y así puede volver al estado de los paquetes en ese momento, el problema que tiene es que la carpeta de los paquetes puede crecer muchisimo muy pronto.
```
